...
public class BlackHoleDialogPluginImpl implements InteractionDialogPlugin {
    ...
    public void optionSelected(String text, Object optionData) {
        ...
        switch (option) {
            case INIT: {
                ...
                if (didAlready) {
                    addText("The event horizon exhibits fluctuations indicative of recent antimatter application.");
                }
            ...
            case ADD_STABLE_DESCRIBE: {
                ...
                addText(
                    "The procedure requires spreading prodigious amounts of antimatter near the event horizon, " +
    ...
    private void createInitialOptions(){
        ...
        options.addOption("Consider inducing a resonance cascade in the black hole's hyperfield, creating a stable location", OptionId.ADD_STABLE_DESCRIBE, null);
        if (hasPK() == true) {
